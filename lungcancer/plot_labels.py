...
# labeling이 맞게 되었는지 확인하기 위해 라벨 데이터를 plot 해본다
...
def plot_images(infiles, fname, paths=None, names=None, max_size=640, max_subplots=16):
    ...
    if fname:
        ...
        os.chdir('E:/HSE/LungCancerDetect/data/labels/frontal/test/') # 생성한 이미지 파일 저장되는 경로
...
lines = split_by_patient(open('test_frontal.txt', 'r').readlines())
