...
from models.yolo_2ch import Model
from utils.autoanchor import check_anchors
from utils.datasets_lung import create_dataloader
...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    #     model = Model(opt.cfg or ckpt['model'].yaml, ch=2, nc=nc).to(device)  # create
    ...
    # else:
    model = Model(opt.cfg, ch=2, nc=nc).to(device)  # create
